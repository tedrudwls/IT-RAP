"""
Round-Robin Policy Baseline Inference: MAADFace dataset + StarGAN model
========================================================================
...
Run:
    python "[MAADFace_StarGAN] roundrobin_infer_entry_point.py"
"""
import subprocess
import os
...
output_file = "roundrobin_maadface_stargan_inference.txt"
print(f"[RoundRobin Baseline] MAADFace / StarGAN  ->  {output_file}")
...
with open(output_file, "w", encoding="utf-8") as f:
    process = subprocess.Popen(
        [
            ...
            "--result_dir", "result_roundrobin_maadface_stargan",
            "--test_iters", "200000",
...
print(f"[RoundRobin Baseline] MAADFace / StarGAN done. Output: {output_file}")

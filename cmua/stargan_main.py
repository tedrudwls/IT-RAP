...
def main(config):
    ...
    run = neptune.init_run(
        project="rudwls281689/deepfake",
        api_token="eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAubmVwdHVuZS5haSIsImFwaV9rZXkiOiIyNWYxMjY2My1kNTVhLTRiOWItYTRlNy1hMmJmYjY1N2Y2MzgifQ==",
    )

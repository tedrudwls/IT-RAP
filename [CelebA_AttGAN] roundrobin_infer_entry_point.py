"""
Round-Robin Policy Baseline Inference: CelebA dataset + AttGAN model
=====================================================================
...
Run:
    python "[CelebA_AttGAN] roundrobin_infer_entry_point.py"
"""
import subprocess
import os
...
output_file = "roundrobin_celeba_attgan_inference.txt"
print(f"[RoundRobin Baseline] CelebA / AttGAN  ->  {output_file}")
...
with open(output_file, "w", encoding="utf-8") as f:
    process = subprocess.Popen(
        [
            ...
            "--result_dir", "result_roundrobin_celeba_attgan",
            "--test_iters", "200000",
...
print(f"[RoundRobin Baseline] CelebA / AttGAN done. Output: {output_file}")
